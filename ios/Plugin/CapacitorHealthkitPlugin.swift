...
public class CapacitorHealthkitPlugin: CAPPlugin {
    ...
    func getSampleType(sampleName: String) -> HKSampleType? {
        ...
        case "fiber":
            return HKQuantityType.quantityType(forIdentifier: HKQuantityTypeIdentifier.dietaryFiber)!
        default:
            return nil
        }
    }
    ...
    func getTypes(items: [String]) -> Set<HKSampleType> {
        ...
        for item in items {
            ...
            case "fiber":
                types.insert(HKQuantityType.quantityType(forIdentifier: HKQuantityTypeIdentifier.dietaryFiber)!)
            default:
